...
#双分支双检测头
from dagr.model.networks.dagr_fusion_seperate_heads_v3_2branch_yolov13 import DAGR
...
#         if args.distributed:
#             train_sampler.set_epoch(epoch)
#         mean_loss = train(train_loader, model, ema, lr_scheduler, optimizer, args, scaler=scaler, run_name=args.exp_name)
#         if args.is_main_process:
#             try:
#                 current_lr = lr_scheduler.get_last_lr()[-1]
#             except Exception:
