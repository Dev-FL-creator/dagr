...
# Paths
PYTHON=python
TEST_SCRIPT=scripts/test_dsec_snn_fusion.py 

# Output
OUTPUT_DIR=/media/data/hucao/jinkai/dagr/logs_snn_fusion
EXP_NAME=fusion_2_timeslices_bs_2_
...
# Checkpoint path
CHECKPOINT="${OUTPUT_DIR}/DSEC_Det/detection/fusion_2_timeslices_bs_2_/last_model.pth" 
