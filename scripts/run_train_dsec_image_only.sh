...
PYTHON=python
TORCHRUN=torchrun
TRAIN_SCRIPT=scripts/train_dsec_image_only.py

OUTPUT_DIR=/media/data/hucao/jinkai/dagr/logs_image_only
EXP_NAME=image_only_sdtv3_bs2

# ------------------------------------------------------------------------------
# 单 Image 分支配置
# ------------------------------------------------------------------------------
# --use_image --no_events 只使用 image 分支训练和推理
...
echo "Starting training with IMAGE ONLY mode..."
