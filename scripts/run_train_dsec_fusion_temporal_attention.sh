...
PYTHON=python
TORCHRUN=torchrun
TRAIN_SCRIPT=scripts/train_dsec_snn_temporal_attention.py

# Output
OUTPUT_DIR=/media/data/hucao/jinkai/dagr/logs_snn_fusion_temporal_attention
EXP_NAME=fusion_2_timeslices_bs_2_temporal_attention
