...
from dagr.model.networks.dagr_fusion_seperate_heads_rvt_2branch import DAGR
...
if __name__ == '__main__':
    ...
    test_loader = DataLoader(test_dataset, sampler=sampler, follow_batch=['bbox', 'bbox0'], 
                             batch_size=args.batch_size, shuffle=False, num_workers=4, drop_last=True)
    
    print("init net - RVT 2-branch fusion")
